...
# and set the argument to `create_cosmos_db_resource_group = false`. Location will be same as existing RG.
#---------------------------------------------------------
# Resource Group Creation
#----------------------------------------------------------
data "azurerm_resource_group" "rg" {
  count = var.create_cosmos_db_resource_group == false ? 1 : 0
...
module "mod_scaffold_rg" {
  ...
  count = var.create_cosmos_db_resource_group ? 1 : 0
