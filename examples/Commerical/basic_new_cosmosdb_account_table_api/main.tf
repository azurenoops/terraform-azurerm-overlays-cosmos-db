...
module "mod_cosmos_db" {
  ...
  # Resource Group, location, workload details
  ...
  # that detects unusual and potentially harmful attempts to access or exploit databases.
  # This will apply to all the cosmosdb accounts created in this module
  ...
  # To use a custom name, set an argument `custom_cosmosdb_table_name` to valid string
